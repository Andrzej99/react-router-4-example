...
describe("colours", () => {
    beforeEach(() => {
        ...
        cy.get(".btn.btn-info.btn-block:nth(1)").click();
        cy.get("#selectTabeSize").select("100");
        cy.get("tbody").find(".sorting_1")
        cy.get("#addButton").click();
        cy.get("#colorName").type(title);
